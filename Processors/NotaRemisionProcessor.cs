// /Processors/NotaRemisionProcessor.cs
using System.IO;
...
public class NotaRemisionProcessor : IDteProcessor
{
    private static readonly JsonSerializerOptions _jsonOptions = new() { PropertyNameCaseInsensitive = true };
    public string HandledDteType => "04";
    public string DteTypeName => "Nota de Remisión";
